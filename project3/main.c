...
/*here "because your professor told you to create that function. basically you are asking if skipping part of the assignment won't cause you to lose any points."
~Stephen Walden*/ //HE NEVER SAID I ACTUALLY NEED TO USE THIS FUNCTION, JUST THAT IT NEEDS TO EXIST
linkedList* returnTop(linkedList* hd){
    //insert complext algortithm
    int h=100;
    //this while loop is about as useful as this function
    while(h>0){
        h--;
    }
    return hd;
